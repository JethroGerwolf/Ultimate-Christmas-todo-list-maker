...
I used Visual studios a to code and test it with live server add on

This is in HTML, CSS, and JavaScript
in other word it is a coded for a website

# Useful Websites

- https://www.w3schools.com/js/default.asp
- https://www.youtube.com/watch?v=W6NZfCO5SIk&t=814s

# Future Work

- need like santa laughter when the he comes accross the screen
- a way to print the list or make a pdf of your list that is nice to look at 
- maybe I will add a login page or something like that
